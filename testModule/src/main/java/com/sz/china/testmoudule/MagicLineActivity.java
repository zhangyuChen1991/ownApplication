...
import com.sz.china.testmoudule.view.MagicLineView;
...
public class MagicLineActivity extends Activity implements View.OnClickListener {
    ...
    private EditText p1xLength;
    @ViewInject(R.id.p1y_length)
    private EditText p1yLength;
    @ViewInject(R.id.p2x_length)
    private EditText p2xLength;
    @ViewInject(R.id.p2y_length)
    private EditText p2yLength;
    @ViewInject(R.id.p1_speed)
    private EditText p1Speed;
    @ViewInject(R.id.p2_speed)
    private EditText p2Speed;
    @ViewInject(R.id.start)
    private Button start;
    @ViewInject(R.id.selete_draw_spinner)
    private Spinner seleteDraw;
    ...
    private float[] data4 = {450, 5, 450, 5, 0.35f, 0.35f};
    ...
    private float[] data8 = {80, 450, 450, 80, 0.04f, 0.05f};
    private float[] data9 = {450, 50, 50, 450, 0.35f, 0.05f};
    ...
    private void initView() {
        ...
        SpinnerAdapter adapter = new ArrayAdapter(this, R.layout.adapter_simple_spinner, spinnerMenu);
