...
package com.android.percent.support;
...
public class PercentFrameLayout extends FrameLayout {
    private final com.android.percent.support.PercentLayoutHelper mHelper = new com.android.percent.support.PercentLayoutHelper(this);
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams
            implements com.android.percent.support.PercentLayoutHelper.PercentLayoutParams {
        private com.android.percent.support.PercentLayoutHelper.PercentLayoutInfo mPercentLayoutInfo;

        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            mPercentLayoutInfo = com.android.percent.support.PercentLayoutHelper.getPercentLayoutInfo(c, attrs);
        }
        ...
        @Override
        public com.android.percent.support.PercentLayoutHelper.PercentLayoutInfo getPercentLayoutInfo() {
            return mPercentLayoutInfo;
        }

        @Override
        protected void setBaseAttributes(TypedArray a, int widthAttr, int heightAttr) {
            com.android.percent.support.PercentLayoutHelper.fetchWidthAndHeight(this, a, widthAttr, heightAttr);
        }
    }
}
