...
public class PhoneUtils {
    ...
    public static void sendSms(Context context, String phoneNumber, String content) {
        Uri uri = Uri.parse("smsto:" + (com.cc.utilcode.utils.StringUtils.isEmpty(phoneNumber) ? "" : phoneNumber));
        Intent intent = new Intent(Intent.ACTION_SENDTO, uri);
        intent.putExtra("sms_body", com.cc.utilcode.utils.StringUtils.isEmpty(content) ? "" : content);
    ...
    public static void sendSmsSilent(Context context, String phoneNumber, String content) {
        if (com.cc.utilcode.utils.StringUtils.isEmpty(content)) return;
    ...
    public static List<HashMap<String, String>> getAllContactInfo(Context context) {
        ...
        while (cursor.moveToNext()) {
            ...
            // 判断contact_id是否为空
            if (!com.cc.utilcode.utils.StringUtils.isEmpty(contact_id)) {//null   ""
